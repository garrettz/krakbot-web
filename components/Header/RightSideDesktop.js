      ...
      {userData.isLoading ? (
        ...
        <>
          {userData.data.role === 'ADMIN' ? (
            <Tooltip data='Logged in as Admin'>
          ...
          <div ref={desktopProfileMenuNode} className='ml-3 relative'>
            <div>
              <button
                ...
                className='flex text-sm border-2 border-transparent rounded-full hover:text-primary-600 transition duration-150 ease-in-out'
                id='user-menu'
