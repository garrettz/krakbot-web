            ...
            <div className="flex">
              ...
              <Link href="/">
                <a className="flex-shrink-0 flex items-center">
                  <img className="hidden lg:block h-8 w-auto" src="/img/logo/logo-on-white.svg" alt="Krakbot logo" />
                  <img className="block lg:hidden h-8 w-auto" src="/img/logo/logo-on-white.svg" alt="Krakbot logo" />
                </a>
              </Link>
              {/* main menu items */}
